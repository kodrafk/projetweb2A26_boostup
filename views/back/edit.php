        ...
        <div class="row">
            <div class="col-12">
                <div class="bg-light rounded p-4">
                    ...
                    <form method="POST" action="index.php?action=edit&id=<?= $event['id'] ?>">
                        <div class="mb-3">
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="is_active" name="is_active" <?= ($event['is_active'] ?? true) ? 'checked' : '' ?>>
