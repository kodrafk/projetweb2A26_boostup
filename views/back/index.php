...
function isValidLocation($location) {
    return preg_match('/^[a-zA-Z]{3,}[a-zA-Z0-9\s,.-]*$/', $location);
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isValidLocation($location)) {
        $errors[] = "Location must start with at least 3 letters and can include numbers after.";
    }
...
// You can display $errors somewhere in your HTML
?>
...
<body>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    <div id="eventFormPage" class="event-form-container">
                        ...
                        <form id="eventForm" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="validation-message error" id="titleValidation">The title must contain at least 3 characters.</div>
                            </div>
                            
                            <div class="form-group">
                                <label for="event_date">Event Date:</label>
                                <input type="date" id="event_date" name="event_date" required>
                                <div class="validation-message error" id="dateValidation">Please select a valid date.</div>
                            </div>
                            
                            <div class="form-group">
                                <label for="location">Location:</label>
                                <input type="text" id="location" name="location" placeholder="e.g. Convention Center, New York" required>
                                <div class="validation-message error" id="locationValidation">The location must contain at least 3 characters.</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="validation-message error" id="linkValidation">Please enter a valid URL.</div>
                            </div>
    ...
    <script>
        // Toggle between events page and form
        ...
        eventForm.addEventListener('submit', function (e) {
            ...
            if (!title) {
                document.getElementById('titleValidation').textContent = 'You must fill out this field.';
            ...
            if (!eventDate) {
                document.getElementById('dateValidation').textContent = 'You must fill out this field.';
            ...
            if (!location) {
                document.getElementById('locationValidation').textContent = 'You must fill out this field.';
