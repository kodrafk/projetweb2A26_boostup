...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="images/bot.jpg" />
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="pages/ui-features/Categories.html">Buttons</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="pages/forms/index.php">Basic Elements</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#charts" aria-expanded="false" aria-controls="charts">
              ...
              <span class="menu-title">Communautés</span>
              <i class="menu-arrow"></i>
            </a>
