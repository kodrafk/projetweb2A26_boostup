...
<div id="userProfileModal" class="profile-modal">
  <div class="modal-content">
    ...
    <input type="hidden" name="id" value="<?php echo isset($_SESSION['user']['iduser']) ? $_SESSION['user']['iduser'] : ''; ?>">
    
    <div class="form-group floating">
        <input type="text" name="firstName" value="<?php echo isset($_SESSION['user']['firstName']) ? htmlspecialchars($_SESSION['user']['firstName']) : ''; ?>" class="form-control" placeholder=" " required>
        <label>Prénom</label>
    </div>
    
    <div class="form-group floating">
        <input type="text" name="lastName" value="<?php echo isset($_SESSION['user']['lastName']) ? htmlspecialchars($_SESSION['user']['lastName']) : ''; ?>" class="form-control" placeholder=" " required>
        <label>Nom</label>
    </div>
    
    <div class="form-group floating">
        <input type="email" name="email" value="<?php echo isset($_SESSION['user']['email']) ? htmlspecialchars($_SESSION['user']['email']) : ''; ?>" class="form-control" placeholder=" " required>
        <label>Email</label>
    </div>
    
    <div class="form-group floating">
        <input type="text" name="numtel" value="<?php echo isset($_SESSION['user']['numtel']) ? htmlspecialchars($_SESSION['user']['numtel']) : ''; ?>" class="form-control" placeholder=" " required>
    ...
    <div class="form-group select-group">
        ...
        <select name="type" class="form-control">
            <option value="entrepreneur" <?php echo (isset($_SESSION['user']['type']) && $_SESSION['user']['type'] === 'entrepreneur') ? 'selected' : ''; ?>>Entrepreneur</option>
            <option value="investor" <?php echo (isset($_SESSION['user']['type']) && $_SESSION['user']['type'] === 'investor') ? 'selected' : ''; ?>>Investor</option>
            <option value="admin" <?php echo (isset($_SESSION['user']['type']) && $_SESSION['user']['type'] === 'admin') ? 'selected' : ''; ?>>Admin</option>
        </select>
    </div>
    
    <div class="modal-footer">
        <button type="button" class="btn btn-outline" onclick="closeUserProfileModal()">Annuler</button>
...
<style>
  ...
  .profile-modal {
    ...
    width: 100%;
    height: 100%;
    background-color: rgba(0,0,0,0.5); /* Fond semi-transparent sans flou */
    overflow-y: auto;
  }
...
<script>
  // Fonctions pour gérer la modal (inchangées)
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row content justify-content-center align-items-center position-relative">
          ...
          <div class="shape shape-2">
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
              <path d="M41.3,-49.1C54.4,-39.3,66.6,-27.2,71.1,-12.1C75.6,3,72.4,20.9,63.3,34.4C54.2,47.9,39.2,56.9,23.2,62.3C7.1,67.7,-10,69.4,-24.8,64.1C-39.7,58.8,-52.3,46.5,-60.1,31.5C-67.9,16.4,-70.9,-1.4,-66.3,-16.6C-61.8,-31.8,-49.7,-45.2,-36.3,-54C-22.9,-63.7,-8.2,-70.6,3.6,-75.1C15.4,-79.6,28.2,-58.9,41.3,-49.1Z" transform="translate(100 100)"></path>
            </svg>
          </div>
