...
class UserC {
    ...
    public function __construct() {
        $this->userModel = new User(null, null, null, null, null, null, null); // Initialisation de User
    }
    ...
    function ajouterUser($user) {
        ...
        try {
            ...
            $query->execute([
                'email'     => $user->getEmail(),
                'password'  => password_hash($user->getPassword(), PASSWORD_DEFAULT), // Hacher le mot de passe
                'type'      => $user->getType(),
